...
[] spawn
{
	...
	while {true} do
	{
		...
		else
		{
			...
			format
			["
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.6'  shadowColor='#000000' image='scripts\statusBar\icons\players.paa' color='%9'/> %2</t>
				<t shadow='1' shadowColor='#000000' color='%14'><img size='1.0'  shadowColor='#000000' image='scripts\statusBar\icons\health.paa' color='%9'/> %3%1</t>
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.0'  shadowColor='#000000' image='scripts\statusBar\icons\poptab_ca.paa' color='%9'/> %4</t>
				<t shadow='1' shadowColor='#000000' color='%15'><img size='1.6'  shadowColor='#000000' image='scripts\statusBar\icons\hunger.paa' color='%9'/> %5%1</t>
				<t shadow='1' shadowColor='#000000' color='%16'><img size='1.6'  shadowColor='#000000' image='scripts\statusBar\icons\thirst.paa' color='%9'/> %6%1</t>
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.0'  shadowColor='#000000' image='scripts\statusBar\icons\exile.paa' color='%9'/> %8</t>
				<t shadow='1' shadowColor='#000000' color='%9'>FPS: %7</t>
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.0'  shadowColor='#000000' image='scripts\statusBar\icons\compass.paa' color='%9'/> %11</t>
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.6'  shadowColor='#000000' image='scripts\statusBar\icons\restart.paa' color='%9'/>%12:%13</t>",
